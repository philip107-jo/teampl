...
export default function Calendar() {
  ...
  return (
    <div className="dashboard pt-4 lg:max-w-[1400px] lg:mx-auto w-full px-4 sm:px-6 lg:px-8">
          ...
          {days.map((day, index) => {
            ...
            return (
              <div
                ...
                className={`min-h-[80px] lg:min-h-0 aspect-auto lg:aspect-square flex flex-col rounded-2xl p-1.5 sm:p-2.5 relative transition-all group select-none ${
              ...
              >
                {day && (
                  <>
                    <span className={`text-[13px] font-black mb-1 sm:mb-2 transition-colors z-10 w-6 h-6 sm:w-7 sm:h-7 rounded-full flex items-center justify-center -ml-0.5 sm:-ml-1 -mt-0.5 sm:-mt-1 ${today && !selected ? "text-[#7C6CFF] bg-[#7C6CFF]/10" : (selected ? "text-white bg-[#7C6CFF]" : (index % 7 === 0 ? "text-[#FF6B7A]" : "text-[#7D879C] dark:text-white/60"))}`}>
                      {day}
                    </span>
